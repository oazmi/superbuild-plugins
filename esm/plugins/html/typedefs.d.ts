/** @module */
import type { ImportedEntity, ImportEntity, MaybePromise, MaybePromiseOrNull, ReducedMetafile, SuperPluginBuild } from "../../deps.js";
import type { EsbuildWarningsAndErrors } from "../../typedefs.js";
import type { ContentStore } from "./content_store.js";
import type { HTML_NODE_TYPE, HtmlNode, StrictOmit } from "./deps.js";
...
*/
export type ReplaceContentFn = (args: ReplaceContentFnArgs, ctx: ReplaceContentFnContext) => MaybePromise<void | undefined | EsbuildWarningsAndErrors>;
...
export interface HtmlDependency extends ImportEntity<HtmlNodeReplacementContentTask>, HtmlNodeReplacementContentTask {
}
...
*/
export type HtmlDependencyCallback = (args: HtmlDependencyArgs, ctx: Pick<ReplaceContentFnContext, "build" | "contentStore">) => MaybePromiseOrNull<StrictOmit<HtmlDependency, "key" | "originalArgs">>;
