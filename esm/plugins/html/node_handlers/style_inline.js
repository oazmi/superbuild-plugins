...
export const styleInlineHandlerFilter = { nodeType: HTML_NODE_TYPE.ELEMENT, nodeName: "style" };
export const styleInlineHandlerCallback = (args, ctx) => {
...
const replaceContent = async (args, ctx) => {
    ...
    child_nodes = node.children, style_text_content = child_nodes.find((child_node) => (child_node.type === HTML_NODE_TYPE.TEXT));
