 ...
 * @module
*/
import { isNull } from "../../deps/jsr.io/@oazmi/kitchensink/0.10.1/src/struct.js";
import { contentsToUint8Array, ensureEndSlash, escapeLiteralStringForRegex, joinPosixPaths, number_isNaN, parseFilepathInfo } from "../../deps.js";
...
export class ContentStore {
    ...
    constructor(build) {
        ...
        build.onEmit({
            ...
            const errors = [], { outputPath, contents, inputs } = args, sources_from_namespace = inputs.filter((input) => { return input.namespace === namespace; }), number_of_sources_from_namespace = sources_from_namespace.length;
