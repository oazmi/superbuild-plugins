...
import type { EsbuildPartialMessage, EsbuildResolveOptions, ImportedEntity, ImportEntity, OnEmitOptions, OnTransformOptions, Require, SuperPluginBuild, SuperPluginSetup } from "../../deps.js"
import { contentsToString, isNull, isRecord, promise_all, relativePath } from "../../deps.js"
import { ContentStore } from "./content_store.js"
import { htmlParse, htmlRender, htmlWalk, type HtmlNode } from "./deps.js"
...
import type { HtmlDependencyArgs, HtmlDependencyCallback, HtmlDependencyEmitData, HtmlNodeReplacementContentTask, NodeHandler, ReplaceContentFnArgs, ReplaceContentFnContext } from "./typedefs.js"
